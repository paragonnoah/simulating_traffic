 ...
 * output: none
 *
 * Sets the specified edgeData in the graph to contain the edgeType value (i.e. a RoadData)
 */
 ...
 * output: an edgeType
 *
 * Finds and returns the specified edgeData (i.e. a RoadData) for this edge in the graph
 */
